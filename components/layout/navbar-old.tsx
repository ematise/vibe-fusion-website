          ...
          <div className="hidden md:flex items-center space-x-6">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-white hover:text-brand-accent transition-colors font-extralight"
              >
                {item.label}
              </Link>
            ))}
            ...
            <div className="flex flex-col space-y-4">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-white hover:text-brand-accent transition-colors px-2 font-extralight"
